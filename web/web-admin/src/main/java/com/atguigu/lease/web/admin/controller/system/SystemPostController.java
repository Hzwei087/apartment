...
public class SystemPostController {
    ...
    public Result removeById(@RequestParam Long id) {
        LambdaQueryWrapper<SystemPost> systemPostQueryWrapper = new LambdaQueryWrapper<>();
        systemPostQueryWrapper.eq(SystemPost::getId,id);
//        systemPostQueryWrapper.eq(SystemPost::getStatus,BaseStatus.DISABLE);
        systemPostService.remove(systemPostQueryWrapper);
        return Result.ok();
    }
    ...
    public Result updateStatusByPostId(@RequestParam Long id, @RequestParam BaseStatus status) {
        ...
        systemPostService.update(systemPostUpdateWrapper);
        return Result.ok();
    }
}
