...
public class LeaseAgreementServiceImpl extends ServiceImpl<LeaseAgreementMapper, LeaseAgreement>
    ...
    @Override
    public IPage<AgreementVo> pageAgreementVoByPage(Page<AgreementVo> page, AgreementQueryVo queryVo) {
        return leaseAgreementMapper.pageAgreementVoByPage(page,queryVo);
    }
