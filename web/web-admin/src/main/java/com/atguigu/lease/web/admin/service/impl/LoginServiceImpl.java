...
public class LoginServiceImpl implements LoginService {
    ...
    @Override
    public String loginByLoginVo(LoginVo loginVo) {
        ...
        if (!captchaCode.toLowerCase().equals(code)){
    ...
    public SystemUserInfoVo getUserInfo(Long userId) {
        SystemUserInfoVo systemUserInfoVo = systemUserMapper.getUserInfo(userId);
